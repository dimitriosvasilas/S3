...
class Config {
    ...
    _getConfig() {
        ...
        if (config.utapi) {
            ...
            // `localCache` is not part of the utapi configuration property.
            assert(config.localCache, 'missing required property of ' +
                'UtapiClient: localCache');
            this.utapi.localCache = config.localCache;
            assert(config.utapi.redis, 'missing required property of ' +
                'UtapiClient: redis');
