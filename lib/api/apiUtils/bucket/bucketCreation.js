...
import { BackendInfo } from '../object/BackendInfo';
...
export function createBucket(authInfo, bucketName, headers,
    ...
    (err, results) => {
        ...
        if ((!locationConstraint && usEastBehavior ||
            BackendInfo.isLegacyAwsBehavior(locationConstraint, usEastBehavior))
            && (!existingBucketMD.getLocationConstraint() && usEastBehavior ||
            BackendInfo.isLegacyAwsBehavior(existingBucketMD
              .getLocationConstraint(), usEastBehavior))) {
